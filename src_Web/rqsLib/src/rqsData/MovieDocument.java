...
public class MovieDocument implements SQLData{
	...
	public Date released_date = new Date(0);
	public double vote_average;
	public int vote_count;
	public String certification = "";
	public Vector<String> actors = new Vector<String>();
	public Vector<String> directors;
	public int runtime;
	public long nb_copies;
	public Vector<String> genres;
	public Vector<String> production_companies;
	public Vector<Language> spoken_languages;
	public Vector<Country> production_countries;
	...
	public MovieDocument(Map<String, Object> rawDocument,Connection connection) {
        ...
        public MovieDocument(Connection connection) {
            this.connection = connection;
        }
	...
	public String toString() {
            String s = String.format("%-3d |  %-4f  |         %s", popularity, durability, title);
            return s;
            /*
	...
	public void writeSQL(SQLOutput stream) throws SQLException {
		...
		if(posterUrl != null){
			try {
                                ImageIO.createImageInputStream(poster);
